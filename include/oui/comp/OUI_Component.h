...
/* START OF VARIABLES */
	...
	//Styling
		...
		private: std::u16string currentProfile;
		protected: oui::Style* definedStyle;//TODO implement defined style
		protected: oui::Style* style;
...
/* START OF METHODS */
	...
	//Usage functions
		...
		public: void setAttribute(std::string name, Attribute a, std::u16string profile = u"default");
