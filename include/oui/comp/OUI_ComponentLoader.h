...
namespace oui {
    ...
    class OUI_API ComponentLoader {
        ...
        public: static bool addTag(const std::string& tag, std::function<Component*(std::string, std::string, std::vector<std::string>, std::vector<std::u16string>)> createComponent);
        ...
        public: bool loadComponents(const std::u16string& path);
